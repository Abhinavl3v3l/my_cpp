...
enum class Model { AX12A = 0, XM430 = 1, MX12W = 2, XC430 = 3, MX64 = 4, MX106 = 5, INVALID = -1 };
...
enum RegisterKey {
    ...
    MOVING,                         // 30
    // MR Addition
    MIN_POSITION_LIMIT,  // 31
    MAX_POSITION_LIMIT,  // 32
    GOAL_VELOCITY,       // 40
    GOAL_ACCELERATION,   // 41
    POSITION_D_GAIN,     // 42
    POSITION_I_GAIN,     // 43
    POSITION_P_GAIN      // 44
