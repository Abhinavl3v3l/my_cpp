...
std::map<RegisterKey, ServoRegister> InitRegisters(Model model) {
    ...
    if ((model == Model::AX12A) || (model == Model::MX12W)) {
        std::map<RegisterKey, ServoRegister> map{
            ...
            {RegisterKey::CW_ANGLE_LIMIT,
             {6, 2, 0, 1023}},  //  Clockwise Angle Limit - The unit is 0.29°.
            {RegisterKey::CCW_ANGLE_LIMIT,
             {8, 2, 0, 1023}},  //  Counter-Clockwise Angle Limit - The unit is 0.29°.
            {RegisterKey::TEMPERATURE_LIMIT,
             {11, 1, 0, 99}},  //  Maximum Internal Temperature Limit - Do not change!!
            ...
            {RegisterKey::MAX_TORQUE,
             {14, 2, 0, 1023}},  //  Maximum Torque -  the unit is about 0.1%.
            {RegisterKey::STATUS_RETURN_LEVEL,
             {16, 1, 0, 3}},  //  Select Types of Status Return (0 - PING, 1 PING READ or 2 ALL)
            ...
            {RegisterKey::MOVING_SPEED,
             {32, 2, 0, 2047}},  //  Moving Speed | Wheel Mode: 0 ~ 2,047(0x7FF) can be used, the
                                 //  unit is about 0.1%. | Join Mode: 0 ~ 1,023(0x3FF) can be used,
                                 //  and the unit is about 0.111rpm.
            {RegisterKey::TORQUE_LIMIT,
             {34, 2, 0, 1023}},  //  Torque Limit(Goal Torque) unit is about 0.1%.
            {RegisterKey::CURRENT_POSITION,
             {36, 2, 0, 1023}},  //  Present Position - unit is 0.29 [°]
            {RegisterKey::CURRENT_SPEED,
             {38, 2, 0, 2047}},  //  Present Speed | Joint Mode - The unit is about 0.111rpm. |
                                 //  Wheel Mode - the unit is about 0.1%.
            {RegisterKey::CURRENT_LOAD, {40, 2, 0, 2047}},  //  Present Load - unit is 0.1%.
            {RegisterKey::CURRENT_VOLTAGE,
             {42, 1, 0,
              255}},  //  Present Voltage - This value is 10 times larger than the actual voltage
        ...
        std::map<RegisterKey, ServoRegister> map{
            ...
            {RegisterKey::TEMPERATURE_LIMIT,
             {31, 1, 0, 1023}},  //  Maximum Internal Temperature Limit - Do not change!!
            ...
            {RegisterKey::CURRENT_POSITION,
             {132, 4, 0, 0}},  //  Present Position - unit is 0.229 [°]
            {RegisterKey::CURRENT_SPEED,
             {128, 4, 0, 0}},  //  Present Speed | Joint Mode - The unit is about 0.111rpm. | Wheel
                               //  Mode - the unit is about 0.1%.
            {RegisterKey::CURRENT_VOLTAGE,
             {144, 2, 0,
              0}},  //  Present Voltage - This value is 10 times larger than the actual voltage
            ...
            {RegisterKey::GOAL_VELOCITY, {104, 4, 0, 5}},        //  GOAL VELOCITY
            {RegisterKey::CURRENT_LOAD, {126, 2, 0, 0}},         //  Present Load - unit is 0.1%.
            {RegisterKey::TORQUE_ENABLE, {64, 1, 0, 1}},         //  Motor Torque On/Off
            {RegisterKey::STATUS_RETURN_LEVEL,
             {68, 1, 0, 2}},  //  Select Types of Status Return (0 - PING, 1 PING READ or 2 ALL)
            {RegisterKey::ACCELERATION_VALUE_OF_PROFILE,
             {108, 4, 0,
              32767}},  //  Sets acceleration of the Profile (0 stand for infinite acceleration)
            {RegisterKey::VELOCITY_VALUE_OF_PROFILE,
             {112, 4, 0, 32767}},  //  Sets speed of the Profile (0 stand for infinite speed)
            {RegisterKey::POSITION_D_GAIN, {80, 2, 0, 16383}},
            {RegisterKey::POSITION_I_GAIN, {82, 2, 0, 16383}},
            {RegisterKey::POSITION_P_GAIN, {84, 2, 0, 16383}},
    ...
    else if (model == Model::MX64 || model == Model::MX106) {
        std::map<RegisterKey, ServoRegister> map{
            {RegisterKey::MODEL_NUMBER, {0, 2, 0, 0}},
            {RegisterKey::FIRMWARE_VERSION, {2, 1, 0, 0}},     //  Firmware Version
            {RegisterKey::DYNAMIXEL_ID, {3, 1, 1, 64}},        //  DYNAMIXEL ID
            ...
            {RegisterKey::RETURN_DELAY_TIME, {5, 1, 0, 254}},  //  Response Delay Time
            {RegisterKey::CW_ANGLE_LIMIT,
             {6, 2, 0, 4095}},  //  Clockwise Angle Limit - The unit is 0.29°.
            {RegisterKey::CCW_ANGLE_LIMIT,
             {8, 2, 0, 4095}},  //  Counter-Clockwise Angle Limit - The unit is 0.29°.
            {RegisterKey::TEMPERATURE_LIMIT,
             {11, 1, 0, 99}},  //  Maximum Internal Temperature Limit - Do not change!!
            ...
            {RegisterKey::MOVING_SPEED,
             {32, 2, 0, 1023}},  //  Moving Speed | Wheel Mode: 0 ~ 2,047(0x7FF) can be used, the
                                 //  unit is about 0.1%. | Join Mode: 0 ~ 1,023(0x3FF) can be used,
                                 //  and the unit is about 0.111rpm.
            {RegisterKey::TORQUE_LIMIT,
             {34, 2, 0, 1023}},  //  Torque Limit(Goal Torque) unit is about 0.1%.
            ...
            {RegisterKey::CURRENT_TEMPERATURE, {43, 1, 0, 255}},  //  Present Temperature in degree
            {RegisterKey::MOVING, {46, 1, 0, 1}},                 //  Movement Status
            {RegisterKey::GOAL_ACCELERATION, {73, 1, 0, 254}},
            {RegisterKey::POSITION_D_GAIN, {26, 2, 0, 254}},
            {RegisterKey::POSITION_I_GAIN, {27, 2, 0, 254}},
            {RegisterKey::POSITION_P_GAIN, {28, 2, 0, 254}}
